...
* @cdk.githash
* @see ShortestPaths
* @see org.openscience.cdk1.ringsearch.RingSearch
*/
@TestClass("org.openscience.cdk1.graph.GraphUtilTest")
...
* cycle
* @see org.openscience.cdk1.ringsearch.RingSearch#isolated()
*/
