...
* {@link org.openscience.cdk1.graph.matrix.TopologicalMatrix} if only the
...
* @see org.openscience.cdk1.graph.matrix.TopologicalMatrix
*/
...
* @see #pathTo(org.openscience.cdk1.interfaces.IAtom)
* @see #atomsTo(int)
* @see #atomsTo(org.openscience.cdk1.interfaces.IAtom)
*/
...
* array of {@link org.openscience.cdk1.interfaces.IAtom}s
* @see #atomsTo(int)
* @see #pathTo(int)
* @see #pathTo(org.openscience.cdk1.interfaces.IAtom)
*/
...
* @see #distanceTo(org.openscience.cdk1.interfaces.IAtom)
*/
