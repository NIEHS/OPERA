 ...
 */
package org.openscience.cdk1.atomtype.mapper;

import org.openscience.cdk1.annotations.TestClass;
import org.openscience.cdk1.annotations.TestMethod;
import org.openscience.cdk1.config.atomtypes.OWLAtomTypeMappingReader;
 ...
 * @cdk.module atomtype
 */
@TestClass("org.openscience.cdk1.atomtype.mapper.AtomTypeMapperTest")
public class AtomTypeMapper {
  ...
  private AtomTypeMapper(String mappingFile, InputStream stream) {
	 ...
	 * For example, the mapping file <code>org.openscience.cdk1.config.data.cdk-sybyl-mappings.owl</code>
