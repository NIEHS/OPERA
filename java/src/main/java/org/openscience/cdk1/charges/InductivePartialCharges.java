 ...
 */
@TestClass("org.openscience.cdk1.charges.InductivePartialChargesTest")
public class InductivePartialCharges implements IChargeCalculator {
    ...
    public IAtomContainer assignInductivePartialCharges(IAtomContainer ac) throws Exception {
        if (factory == null) {
            factory = AtomTypeFactory.getInstance("org/openscience/cdk1/config/data/jmol_atomtypes.txt", 
                ac.getBuilder());
        }
