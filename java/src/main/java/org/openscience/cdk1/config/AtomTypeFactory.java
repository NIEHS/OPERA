 ...
 */
package org.openscience.cdk1.config;
...
import org.openscience.cdk1.exception.NoSuchAtomTypeException;
 ...
 *    "org/openscience/cdk1/config/data/jmol_atomtypes.txt",
 ...
 */
@TestClass("org.openscience.cdk1.config.AtomTypeFactoryTest")
public class AtomTypeFactory {
    ...
    public static AtomTypeFactory getInstance(IChemObjectBuilder builder) {
        return getInstance("org/openscience/cdk1/config/data/structgen_atomtypes.xml", builder);
    }

    /**
     * Method to create a specialized AtomTypeFactory. Available lists in CDK are:
     * <ul>
     *  <li>org/openscience/cdk1/config/data/jmol_atomtypes.txt
     *  <li>org/openscience/cdk1/config/data/mol2_atomtypes.xml
     *  <li>org/openscience/cdk1/config/data/structgen_atomtypes.xml
     *  <li>org/openscience/cdk1/config/data/mm2_atomtypes.xml
     *  <li>org/openscience/cdk1/config/data/mmff94_atomtypes.xml
     *  <li>org/openscience/cdk1/dict/data/cdk-atom-types.owl
     *  <li>org/openscience/cdk1/dict/data/sybyl-atom-types.owl
     * </ul>
     *
        ...
        try {
            if (format.equals(TXT_EXTENSION)) {
                return (IAtomTypeConfigurator) this.getClass().getClassLoader().
                    loadClass("org.openscience.cdk1.config.TXTBasedAtomTypeConfigurator").
                    newInstance();
            } else if (format.equals(XML_EXTENSION)) {
                return (IAtomTypeConfigurator) this.getClass().getClassLoader().
                 loadClass("org.openscience.cdk1.config.CDKBasedAtomTypeConfigurator").
                 newInstance();
            } else if (format.equals(OWL_EXTENSION)) {
                return (IAtomTypeConfigurator) this.getClass().getClassLoader().
                 loadClass("org.openscience.cdk1.config.OWLBasedAtomTypeConfigurator").
                 newInstance();
            }
		} catch (Exception exc) {
    ...
    public IAtom configure(IAtom atom) throws CDKException {
        ...
        try {
            ...
            Object color = atomType.getProperty("org.openscience.cdk1.renderer.color");
            if (color != null) {
                atom.setProperty("org.openscience.cdk1.renderer.color", color);
            }
