...
import org.openscience.cdk1.config.atomtypes.AtomTypeReader;
 ...
 * can be found in CVS in the src/org/openscience/cdk1/config/data directory.
 *
 * @cdk.module core
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.config.CDKBasedAtomTypeConfiguratorTest")
public class CDKBasedAtomTypeConfigurator implements IAtomTypeConfigurator {

    private String configFile = "org.openscience.cdk1.config.data.structgen_atomtypes.xml";
