...
import org.openscience.cdk1.config.isotopes.IsotopeReader;
 ...
 * org.openscience.cdk1.config.isotopes.xml in the cdk-standard
 ...
 * @cdk.keyword    element
 */
@TestClass("org.openscience.cdk1.config.IsotopeFactoryTest")
public class IsotopeFactory
{
	...
	private IsotopeFactory(IChemObjectBuilder builder) throws IOException {
        ...
        try {
            String configFile = "org/openscience/cdk1/config/data/isotopes.xml";
