 ...
 */
@TestClass("org.openscience.cdk1.config.TXTBasedAtomTypeConfiguratorTest")
public class TXTBasedAtomTypeConfigurator implements IAtomTypeConfigurator {

    private String configFile = "org/openscience/cdk1/config/data/jmol_atomtypes.txt";
            ...
            while (true) {
                ...
                if (!string.startsWith("#")) {
                    ...
                    if (tokenCount == 9) {
                        ...
                        atomType.setProperty("org.openscience.cdk1.renderer.color", color);
