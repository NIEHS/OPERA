...
package org.openscience.cdk1.geometry.surface;
...
public class NumericalSurface {
     ...
     *
     * This constructor use the Van der Waals radii as defined in <i>org/openscience/cdk1/config/data/jmol_atomtypes.txt</i>
