...
import org.openscience.cdk1.io.formats.Mol2Format;
 ...
 */
@TestClass("org.openscience.cdk1.io.Mol2ReaderTest")
    ...
    private IMolecule readMolecule(IMolecule molecule) throws CDKException {
        ...
        try {
            atFactory = AtomTypeFactory.getInstance(
                    "org/openscience/cdk1/config/data/mol2_atomtypes.xml", molecule.getBuilder()
            );
        } catch (Exception exception) {
