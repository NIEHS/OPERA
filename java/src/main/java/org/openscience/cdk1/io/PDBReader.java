...
import org.openscience.cdk1.graph.rebond.RebondTool;
...
import org.openscience.cdk1.protein.data.PDBStrand;
 ...
 * @cdk.bug     1794439
 */
@TestClass("org.openscience.cdk1.io.PDBReaderTest")
public class PDBReader extends DefaultChemObjectReader {
	...
	private static final String hetDictionaryPath = 
	    "org/openscience/cdk1/config/data/type_map.txt";
	...
	public <T extends IChemObject> T read(T oObj) throws CDKException {
		if (oObj instanceof IChemFile) {
			if (pdbFactory == null) {
				try {
					pdbFactory = AtomTypeFactory.getInstance("org/openscience/cdk1/config/data/pdb_atomtypes.xml", 
...
//						01234567890123456789012345678901234567890123456789012345678901234567890123456789
	...
	private boolean createBondsWithRebondTool(IMolecule molecule){
		...
		try {
//			 configure atoms
		      AtomTypeFactory factory = AtomTypeFactory.getInstance("org/openscience/cdk1/config/data/jmol_atomtypes.txt", 
		    	  molecule.getBuilder());
	    ...
	    if (hetDictionary == null) {
	        ...
	        cdkAtomTypeFactory = 
	            AtomTypeFactory.getInstance(
	                    "org/openscience/cdk1/dict/data/cdk-atom-types.owl",
