...
import org.openscience.cdk1.io.formats.RGroupQueryFormat;
import org.openscience.cdk1.isomorphism.matchers.IRGroupQuery;
import org.openscience.cdk1.isomorphism.matchers.RGroup;
import org.openscience.cdk1.isomorphism.matchers.RGroupList;
import org.openscience.cdk1.isomorphism.matchers.RGroupQuery;
 ...
 */
@TestClass("org.openscience.cdk1.io.RGroupQueryReaderTest")
public class RGroupQueryReader extends DefaultChemObjectReader {
    ...
    /**
     * Parse the RGFile. Uses of {@link org.openscience.cdk1.io.MDLV2000Reader}
