...
import org.openscience.cdk1.tools.manipulator.AtomContainerSetManipulator;
 ...
 * @see         org.openscience.cdk1.graph.ConnectivityChecker#partitionIntoMolecules(IAtomContainer)
 * @cdk.keyword Layout
...
public class StructureDiagramGenerator
{
	...
	public void generateCoordinates(Vector2d firstBondVector) throws CDKException
	{
		 ...
		 *  Those are stored as CML in <i>org/openscience/cdk1/layout/templates</i>.
		 */
