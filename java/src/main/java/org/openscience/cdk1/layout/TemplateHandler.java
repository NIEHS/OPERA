 ...
 */
package org.openscience.cdk1.layout;
...
import org.openscience.cdk1.io.CMLReader;
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.layout.TemplateHandlerTest")
public class TemplateHandler
{
	 ...
	 * SDG, place a drawing with the new template in org/openscience/cdk1/layout/templates and add the
	 * template filename to org/openscience/cdk1/layout/templates/template.list
	 */
	@TestMethod("testInit")
	public void loadTemplates(IChemObjectBuilder builder)
	{
		...
		try
		{
			InputStream ins = this.getClass().getClassLoader().getResourceAsStream("org/openscience/cdk1/layout/templates/templates.list");
			BufferedReader reader = new BufferedReader(new InputStreamReader(ins));
			while (reader.ready()) {
					line = reader.readLine();
					line = "org/openscience/cdk1/layout/templates/" + line;
