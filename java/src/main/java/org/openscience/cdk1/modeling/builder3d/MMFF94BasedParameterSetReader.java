...
import org.openscience.cdk1.AtomType;
...
public class MMFF94BasedParameterSetReader {
	...
	private String configFile = "org/openscience/cdk1/modeling/forcefield/data/mmff94.prm";
	...
	private String configFilevdW = "org/openscience/cdk1/modeling/forcefield/data/mmffvdw.prm";
	private InputStream insvdW = null;
	private StringTokenizer stvdW;
	private String sidvdW;

	private String configFileDFSB = "org/openscience/cdk1/modeling/forcefield/data/mmffdfsb.par";
...
//			logger.debug("vdwError: Malformed Number due to:"+nfe2);
	...
	private void setAtomTypes() throws Exception {
		...
		atomType.setProperty("org.openscience.cdk1.renderer.color", co);
