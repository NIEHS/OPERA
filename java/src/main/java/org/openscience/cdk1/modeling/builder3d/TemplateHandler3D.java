...
import org.openscience.cdk1.fingerprint.FingerprinterTool;
...
public class TemplateHandler3D {
    ...
    private void loadTemplates() throws CDKException{
        ...
        try {
            ins = this.getClass().getClassLoader().getResourceAsStream("org/openscience/cdk1/modeling/builder3d/data/ringTemplateStructures.sdf.gz");
        ...
        try {
            ...
            ins = this.getClass().getClassLoader().getResourceAsStream("org/openscience/cdk1/modeling/builder3d/data/ringTemplateFingerprints.txt.gz");
            fin = new BufferedReader(new InputStreamReader(new GZIPInputStream(ins)));
