 ...
 */
package org.openscience.cdk1.pharmacophore;
...
import org.openscience.cdk1.geometry.GeometryTools;
...
import org.openscience.cdk1.isomorphism.UniversalIsomorphismTester;
...
import org.openscience.cdk1.isomorphism.mcss.RMap;
import org.openscience.cdk1.smiles.smarts.SMARTSQueryTool;
 ...
 * distances between them. Each pharmacophore group is represented by a {@link org.openscience.cdk1.pharmacophore.PharmacophoreAtom}
 * and the distances between them are represented by a {@link org.openscience.cdk1.pharmacophore.PharmacophoreBond}.
 * These are collected in a {@link org.openscience.cdk1.isomorphism.matchers.QueryAtomContainer}.
 * <p/>
 ...
 * This can easily be accomplished using this class together with the {@link org.openscience.cdk1.ConformerContainer}
 ...
 * @see org.openscience.cdk1.pharmacophore.PharmacophoreAtom
 * @see org.openscience.cdk1.pharmacophore.PharmacophoreBond
 * @see org.openscience.cdk1.pharmacophore.PharmacophoreQueryAtom
 * @see org.openscience.cdk1.pharmacophore.PharmacophoreQueryBond
 */
@TestClass("org.openscience.cdk1.pharmacophore.PharmacophoreMatcherTest")
public class PharmacophoreMatcher {
     ...
     * @throws org.openscience.cdk1.exception.CDKException
     *          if the query pharmacophore was not set or the query is invalid or if the molecule
     *          does not have 3D coordinates
     * @see #matches(org.openscience.cdk1.interfaces.IAtomContainer, boolean)
     */
     ...
     * @see org.openscience.cdk1.pharmacophore.PharmacophoreBond
     * @see org.openscience.cdk1.pharmacophore.PharmacophoreAngleBond
     */
     ...
     * HashMap corresponding to a seperate match. Each HashMap is keyed on the {@link org.openscience.cdk1.pharmacophore.PharmacophoreBond}
     * in the target molecule that matched a contstraint ({@link org.openscience.cdk1.pharmacophore.PharmacophoreQueryBond} or
     * {@link org.openscience.cdk1.pharmacophore.PharmacophoreQueryAngleBond}. The value is the corresponding query bond.
     *
