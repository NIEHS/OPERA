 ...
 */
@TestClass("org.openscience.cdk1.pharmacophore.PharmacophoreUtilityTest")
public class PharmacophoreUtils {
     ...
     * and return a list fo {@link org.openscience.cdk1.pharmacophore.PharmacophoreQuery} objects which can be used with
     ...
     * available as the <i>"description"</i> property of the {@link org.openscience.cdk1.pharmacophore.PharmacophoreQuery} object.
     * <p/>
     * Example usage is
     * <pre>
     ...
     * @return A list of {@link org.openscience.cdk1.pharmacophore.PharmacophoreQuery} objects
     ...
     * @see org.openscience.cdk1.pharmacophore.PharmacophoreQuery
     * @see org.openscience.cdk1.pharmacophore.PharmacophoreMatcher
     */
     ...
     * Pharmacophore queries can be saved in an XML format which is described XXX. The
     * file can contain multiple definitions. This method will process all the definitions
     * and return a list of {@link org.openscience.cdk1.pharmacophore.PharmacophoreQuery} objects which can be used with
     * the {@link PharmacophoreMatcher} class.
     * <p/>
     * The current schema for the document allows one to specify angle and distance
     * constraints.
