 ...
 */
package org.openscience.cdk1.qsar;
...
import org.openscience.cdk1.dict.Dictionary;
import org.openscience.cdk1.dict.DictionaryDatabase;
import org.openscience.cdk1.dict.Entry;
 ...
 * @see Dictionary
 * @see org.openscience.cdk1.dict.OWLFile
 */
@TestClass(value="org.openscience.cdk1.qsar.DescriptorEngineTest")
public class DescriptorEngine {
     ...
     * <p/>
     * <pre>
     * List classNames = DescriptorEngine.getDescriptorClassNameByPackage("org.openscience.cdk1.qsar.descriptors.molecular",
     *                                                          null);
    ...
    public DescriptorEngine(int type, String[] jarFileNames) {
        switch (type) {
            case ATOMIC:
                classNames = getDescriptorClassNameByPackage("org.openscience.cdk1.qsar.descriptors.atomic", jarFileNames);
                break;
            case BOND:
                classNames = getDescriptorClassNameByPackage("org.openscience.cdk1.qsar.descriptors.bond", jarFileNames);
                break;
            case MOLECULAR:
                classNames = getDescriptorClassNameByPackage("org.openscience.cdk1.qsar.descriptors.molecular", jarFileNames);
                break;
            case ATOMPAIR:
                classNames = getDescriptorClassNameByPackage("org.openscience.cdk1.qsar.descriptors.atompair", jarFileNames);
                break;
        }
        descriptors = instantiateDescriptors(classNames);
        speclist = initializeSpecifications(descriptors);
     ...
     * is automatcally set to "org.openscience.cdk1.qsar.descriptors" and as a result will return
    ...
    public static List<String> getDescriptorClassNameByPackage(String packageName, String[] jarFileNames) {
        ...
        if (packageName == null || packageName.equals("")) {
            packageName = "org.openscience.cdk1.qsar.descriptors";
        }
