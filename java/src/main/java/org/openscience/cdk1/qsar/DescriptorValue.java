...
import org.openscience.cdk1.qsar.result.*;
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.qsar.DescriptorValueTest")
public class DescriptorValue implements Serializable{
     ...
     * <p/>
     * Note that by default if a descriptor returns a single value (such as {@link org.openscience.cdk1.qsar.descriptors.molecular.ALOGPDescriptor}
