...
import org.openscience.cdk1.qsar.AbstractAtomicDescriptor;
...
import org.openscience.cdk1.tools.HOSECodeGenerator;
 ...
 */
@TestClass(value="org.openscience.cdk1.qsar.descriptors.atomic.ProtonAffinityHOSEDescriptorTest")
		...
		public double extractAffinity(IAtomContainer container, IAtom atom) {
			...
			if(familyHalogen(atom)){
				...
				if(listGroup.containsKey(name)){
					...
					String path = "org/openscience/cdk1/qsar/descriptors/atomic/data/"+name;
					String pathS = "org/openscience/cdk1/qsar/descriptors/atomic/data/"+nameS;
