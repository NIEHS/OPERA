 ...
 */
@TestClass("org.openscience.cdk1.qsar.descriptors.molecular.LengthOverBreadthDescriptorTest")
public class LengthOverBreadthDescriptor implements IMolecularDescriptor {
     ...
     * @return A {@link org.openscience.cdk1.qsar.result.DoubleArrayResult} containing LOBMAX and LOBMIN in that
     *         order     
     */
    ...
    private double[] extents(IAtomContainer atomContainer, double[][] coords, boolean withRadii) throws CDKException {
        ...
        for (int i = 0; i < natom; i++) {
            ...
            if (withRadii) {
                ...
                double radius = org.openscience.cdk1.tools.periodictable.PeriodicTable.getCovalentRadius(atom.getSymbol());
