...
import org.openscience.cdk1.exception.NoSuchAtomException;
import org.openscience.cdk1.graph.PathTools;
import org.openscience.cdk1.graph.SpanningTree;
import org.openscience.cdk1.graph.matrix.ConnectionMatrix;
...
import org.openscience.cdk1.qsar.result.IntegerResult;
...
@TestClass("org.openscience.cdk1.qsar.descriptors.molecular.LongestAliphaticChainDescriptorTest")
public class LongestAliphaticChainDescriptor implements IMolecularDescriptor {
	 ...
	 *@exception  org.openscience.cdk1.exception.CDKException  Description of the
	 *      Exception
	 */
