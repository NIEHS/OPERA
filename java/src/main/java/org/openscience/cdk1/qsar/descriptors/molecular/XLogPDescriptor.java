 ...
 */
package org.openscience.cdk1.qsar.descriptors.molecular;
...
import org.openscience.cdk1.graph.BFSShortestPath;
import org.openscience.cdk1.graph.MoleculeGraphs;
import org.openscience.cdk1.interfaces.*;
import org.openscience.cdk1.interfaces.IAtomType.Hybridization;
import org.openscience.cdk1.isomorphism.UniversalIsomorphismTester;
import org.openscience.cdk1.isomorphism.matchers.*;
...
import org.openscience.cdk1.qsar.result.IDescriptorResult;
 ...
 */
@TestClass("org.openscience.cdk1.qsar.descriptors.molecular.XLogPDescriptorTest")
...
//		 ortho oxygen pair
     ...
     * be obtained from the {@link org.openscience.cdk1.qsar.DescriptorValue} object. Note that the same result
     * can be achieved by interrogating the {@link org.openscience.cdk1.qsar.DescriptorValue} object; this method
     * allows you to do the same thing, without actually calculating the descriptor.
     *
     * @return an object that implements the {@link org.openscience.cdk1.qsar.result.IDescriptorResult} interface indicating
     *         the actual type of values returned by the descriptor in the {@link org.openscience.cdk1.qsar.DescriptorValue} object
     */
    ...
    private boolean getPresenceOfSulfat(IAtomContainer ac, IAtom atom) {
        java.util.List<IAtom> neighbours = ac.getConnectedAtomsList(atom);
        //org.openscience.cdk1.interfaces.IAtom[] second = null;
        //IBond bond = null;
        //int counter = 0;
        for (IAtom neighbour : neighbours) {
    ...
    private boolean getIfCarbonIsHydrophobic(IAtomContainer ac, IAtom atom) {
        ...
        //org.openscience.cdk1.interfaces.IAtom[] fourth = null;
        if (first.size() > 0) {
            for (int i = 0; i < first.size(); i++) {
