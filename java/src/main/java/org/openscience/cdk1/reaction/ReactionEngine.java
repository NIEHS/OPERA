 ...
 */
package org.openscience.cdk1.reaction;
...
import org.openscience.cdk1.dict.EntryReact;
 ...
 * 
 */
@TestClass("org.openscience.cdk1.reaction.ReactionEngineTest")
public class ReactionEngine{
	...
	private void extractMechanism(EntryReact entry) {
		String mechanismName = "org.openscience.cdk1.reaction.mechanism."+entry.getMechanism();
		try {
	...
	private void initiateParameterMap2(EntryReact entry){
		...
		for(Iterator<List<String>> it = paramDic.iterator(); it.hasNext();){
			...
			String paramName = "org.openscience.cdk1.reaction.type.parameters."+param.get(0);
			try {
