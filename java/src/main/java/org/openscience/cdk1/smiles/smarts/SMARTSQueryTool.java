 ...
 */
package org.openscience.cdk1.smiles.smarts;
...
import org.openscience.cdk1.smiles.smarts.parser.SMARTSParser;
import org.openscience.cdk1.smiles.smarts.parser.TokenMgrError;
 ...
 * org.openscience.cdk1.aromaticity.CDKHueckelAromaticityDetector} only considers single rings and two fused non-spiro
 ...
 * @cdk.bug 1761027
 */
@TestClass("org.openscience.cdk1.smiles.smarts.SMARTSQueryToolTest")
public class SMARTSQueryTool {
     ...
     * @see #getMatchingAtoms()
     * @see #countMatches()
     * @see #matches(org.openscience.cdk1.interfaces.IAtomContainer)
     */
     ...
     * after {@link #matches(org.openscience.cdk1.interfaces.IAtomContainer)}. If not, the results may be undefined.
     *
    ...
    private void initializeMolecule() throws CDKException {
        // Code copied from
        // org.openscience.cdk1.qsar.descriptors.atomic.AtomValenceDescriptor;
