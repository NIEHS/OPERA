 ...
 *
 */
package org.openscience.cdk1.smsd.algorithm.rgraph;
...
import org.openscience.cdk1.smsd.algorithm.matchers.AtomMatcher;
import org.openscience.cdk1.smsd.algorithm.matchers.BondMatcher;
import org.openscience.cdk1.smsd.algorithm.matchers.DefaultBondMatcher;
import org.openscience.cdk1.smsd.algorithm.matchers.DefaultMatcher;
import org.openscience.cdk1.smsd.algorithm.matchers.DefaultRGraphAtomMatcher;
import org.openscience.cdk1.smsd.global.TimeOut;
import org.openscience.cdk1.smsd.tools.TimeManager;
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.smsd.algorithm.cdk.CDKMCSTest")
public class CDKMCS {
     ...
     * @throws org.openscience.cdk1.exception.CDKException if the first molecule is an instance
     ...
     * @throws org.openscience.cdk1.exception.CDKException if the first molecules is not an instance of
     *  {@link org.openscience.cdk1.isomorphism.matchers.IQueryAtomContainer}
     */
     ...
     * @throws org.openscience.cdk1.exception.CDKException if there is atom problem in obtaining
     * subgraphs
     */
     ...
     * @throws org.openscience.cdk1.exception.CDKException if it takes too long to identify overlaps
     */
     ...
     * @param  ac1   first molecule. Must not be an IQueryAtomContainer.
     * @param  ac2   second molecule. May be an IQueryAtomContainer.
     * @throws org.openscience.cdk1.exception.CDKException if it takes too long to get the overlaps
     */
