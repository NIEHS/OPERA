 ...
 */
package org.openscience.cdk1.smsd.algorithm.vflib;
...
import org.openscience.cdk1.smsd.algorithm.mcgregor.McGregor;
import org.openscience.cdk1.smsd.algorithm.vflib.interfaces.IMapper;
import org.openscience.cdk1.smsd.algorithm.vflib.interfaces.INode;
import org.openscience.cdk1.smsd.algorithm.vflib.interfaces.IQuery;
import org.openscience.cdk1.smsd.algorithm.vflib.map.VFMCSMapper;
import org.openscience.cdk1.smsd.algorithm.vflib.query.QueryCompiler;
import org.openscience.cdk1.smsd.interfaces.AbstractMCSAlgorithm;
import org.openscience.cdk1.smsd.interfaces.IMCSBase;
 ...
 *
 * First the algorithm runs VF lib {@link org.openscience.cdk1.smsd.algorithm.vflib.map.VFMCSMapper}
 * and reports MCS between
 * run query and target graphs. Then these solutions are extended
 * using McGregor {@link org.openscience.cdk1.smsd.algorithm.mcgregor.McGregor}
 ...
 */
@TestClass("org.openscience.cdk1.smsd.algorithm.vflib.VFlibMCSHandlerTest")
