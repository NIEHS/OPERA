 ...
 */
package org.openscience.cdk1.templates;
...
import org.openscience.cdk1.AminoAcid;
import org.openscience.cdk1.ChemFile;
import org.openscience.cdk1.dict.DictRef;
...
import org.openscience.cdk1.tools.manipulator.AminoAcidManipulator;
    ...
    public synchronized static AminoAcid[] createAAs() {
        ...
        CMLReader reader = new CMLReader(
        	AminoAcids.class.getClassLoader().getResourceAsStream(
        			"org/openscience/cdk1/templates/data/list_aminoacids.cml"
        	)
        );
        try {
        	...
        	while(iterator.hasNext())
        	{
        		...
        		while (atoms.hasNext()) {
        			...
        			String dictRef = (String)atom.getProperty("org.openscience.cdk1.dict");
