 ...
 * @cdk.module     standard
 */
@TestClass("org.openscience.cdk1.tools.HOSECodeGeneratorTest")
public class HOSECodeGenerator implements java.io.Serializable
{
	 ...
	 * @exception  org.openscience.cdk1.exception.CDKException  Thrown if something is wrong
	 */
   ...
   * for this method to work properly.
	 ...
	 *@exception  org.openscience.cdk1.exception.CDKException  If something goes wrong.
	 */
...
//		        rootNode.childs.addElement(tempNode);
  ...
  @TestMethod("testMakeBremserCompliant")
	 ...
	 *
	 *@exception  org.openscience.cdk1.exception.CDKException  Thrown if something goes wrong
	 */
