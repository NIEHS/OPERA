...
import org.openscience.cdk1.tools.manipulator.*;
 ...
 */
@TestClass("org.openscience.cdk1.tools.IDCreatorTest")
public abstract class IDCreator {
     ...
     *
     * @see #createIDs(org.openscience.cdk1.interfaces.IChemObject)
     */
