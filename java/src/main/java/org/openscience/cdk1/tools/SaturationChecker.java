 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.tools.SaturationCheckerTest")
public class SaturationChecker implements IValencyChecker, IDeduceBondOrderTool {
        ...
        if (structgenATF == null) {
            try {
                structgenATF = AtomTypeFactory.getInstance(
                    "org/openscience/cdk1/config/data/structgen_atomtypes.xml", 
                    builder
                );
	 ...
	 * Consider using import org.openscience.cdk1.smiles.DeduceBondSystemTool, which should work better
	 *
