 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.tools.manipulator.AtomContainerComparatorTest")
public class AtomContainerComparator implements Comparator<IAtomContainer> {
   ...
   * @throws org.openscience.cdk1.exception.CDKException if an error occurs with the IsotopeFactory
