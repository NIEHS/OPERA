 ...
 *  */
package org.openscience.cdk1.tools.manipulator;
...
import org.openscience.cdk1.interfaces.IStereoElement;
 ...
 */
@TestClass("org.openscience.cdk1.tools.manipulator.AtomContainerManipulatorTest")
public class AtomContainerManipulator {
     ...
     * {@link MolecularFormulaManipulator#getMajorIsotopeMass(org.openscience.cdk1.interfaces.IMolecularFormula)}
     ...
     *
     * This method is the reverse of {@link #percieveAtomTypesAndConfigureAtoms(org.openscience.cdk1.interfaces.IAtomContainer)}
     * and after a call to this method all atoms will be "unconfigured".
     *
     * Note that it is not a complete reversal of {@link #percieveAtomTypesAndConfigureAtoms(org.openscience.cdk1.interfaces.IAtomContainer)}
     ...
     * @see #percieveAtomTypesAndConfigureAtoms(org.openscience.cdk1.interfaces.IAtomContainer)
     */
    ...
    public static void clearAtomConfigurations(IAtomContainer container) {
        for (IAtom atom : container.atoms()) {
            ...
            atom.setProperty("org.openscience.cdk1.renderer.color", CDKConstants.UNSET);
