 ...
 *
 * @see org.openscience.cdk1.AtomContainer#removeAtomAndConnectedElectronContainers(IAtom)
 *
 * @cdk.module standard
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.tools.manipulator.ChemSequenceManipulatorTest")
