 ...
 */
@TestClass("org.openscience.cdk1.formula.MolecularFormulaManipulatorTest")
public class MolecularFormulaManipulator {
	 ...
	 * @return                    The filled IMolecularFormula
	 * @see                       #getMolecularFormula(String, org.openscience.cdk1.interfaces.IChemObjectBuilder)
	 * @see #getMolecularFormula(String, boolean, org.openscience.cdk1.interfaces.IChemObjectBuilder)
	 */
	...
	public static double getDBE(IMolecularFormula formula) throws CDKException{
		...
		AtomTypeFactory factory = AtomTypeFactory.getInstance("org/openscience/cdk1/config/data/structgen_atomtypes.xml", ac.getBuilder());
