 ...
 */
package org.openscience.cdk1.tools.periodictable;
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.tools.periodictable.ElementPTFactoryTest")
class ElementPTFactory
{
	...
	private ElementPTFactory() throws IOException
	{
		...
		String errorMessage = "There was a problem getting org.openscience.cdk1." +
                              "config.chemicalElements.xml as a stream";
		try {
			String configFile = "org/openscience/cdk1/config/data/chemicalElements.xml";
     ...
     * @see org.openscience.cdk1.tools.periodictable.PeriodicTableElement
     */
     ...
     * @throws org.openscience.cdk1.exception.CDKException if there is an error during configuration
	...
	public int getPeriod(PeriodicTableElement element){
    	org.openscience.cdk1.tools.periodictable.PeriodicTableElement elementInt = getElement(element.getSymbol());
