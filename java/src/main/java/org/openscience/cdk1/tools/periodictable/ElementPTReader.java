 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.tools.periodictable.ElementPTReaderTest")
class ElementPTReader {
     ...
     */
    @TestMethod("testReading")
    public List<org.openscience.cdk1.tools.periodictable.PeriodicTableElement> readElements() {
        List<PeriodicTableElement> elements = new ArrayList<org.openscience.cdk1.tools.periodictable.PeriodicTableElement>();
        try {
        ...
        ElementPTHandler handler = new org.openscience.cdk1.tools.periodictable.ElementPTHandler();
