 ...
 * of {@link org.openscience.cdk1.tools.periodictable.PeriodicTableElement}, this utility
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk1.tools.periodictable.PeriodicTableTest")
public class PeriodicTable {
    ...
    private static void readVDW() throws IOException {
        ...
        String filename = "org/openscience/cdk1/config/data/radii-vdw.txt";
     ...
     private static void readCovalent() throws IOException {
        ...
        String filename = "org/openscience/cdk1/config/data/radii-covalent.txt";
        InputStream ins = PeriodicTable.class.getClassLoader().getResourceAsStream(filename);
        BufferedReader reader = new BufferedReader(new InputStreamReader(ins));
    ...
    private static void readPEneg() throws IOException {
        // now read in the VdW radii
        String filename = "org/openscience/cdk1/config/data/electroneg-pauling.txt";
        InputStream ins = PeriodicTable.class.getClassLoader().getResourceAsStream(filename);
        BufferedReader reader = new BufferedReader(new InputStreamReader(ins));
