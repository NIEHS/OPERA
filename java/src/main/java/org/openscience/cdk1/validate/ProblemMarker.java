 ...
 */
@TestClass("org.openscience.cdk1.validate.ProblemMarkerTest")
public class ProblemMarker {

    public static String ERROR_MARKER = "org.openscience.cdk1.validate.error";
    public static String WARNING_MARKER = "org.openscience.cdk1.validate.warning";
