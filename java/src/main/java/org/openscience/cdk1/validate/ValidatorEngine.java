...
public class ValidatorEngine implements IValidator {
    ...
    public ValidationReport validateAtom(IAtom subject) {
        logger.info("Validating org.openscience.cdk1.Atom");
    ...
    public ValidationReport validateAtomContainer(IAtomContainer subject) {
        logger.info("Validating org.openscience.cdk1.AtomContainer");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateAtomType(IAtomType subject) {
        logger.info("Validating org.openscience.cdk1.AtomType");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateBond(IBond subject) {
        logger.info("Validating org.openscience.cdk1.Bond");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateChemFile(IChemFile subject) {
        logger.info("Validating org.openscience.cdk1.ChemFile");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateChemModel(IChemModel subject) {
        logger.info("Validating org.openscience.cdk1.ChemModel");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateChemObject(IChemObject subject) {
        logger.info("Validating org.openscience.cdk1.ChemObject");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateChemSequence(IChemSequence subject) {
        logger.info("Validating org.openscience.cdk1.ChemSequence");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateCrystal(ICrystal subject) {
        logger.info("Validating org.openscience.cdk1.Crystal");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateElectronContainer(IElectronContainer subject) {
        logger.info("Validating org.openscience.cdk1.ElectronContainer");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateElement(IElement subject) {
        logger.info("Validating org.openscience.cdk1.Element");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateIsotope(IIsotope subject) {
        logger.info("Validating org.openscience.cdk1.Isotope");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateMolecule(IMolecule subject) {
        logger.info("Validating org.openscience.cdk1.Molecule");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateReaction(IReaction subject) {
        logger.info("Validating org.openscience.cdk1.Reaction");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateMoleculeSet(IMoleculeSet subject) {
        logger.info("Validating org.openscience.cdk1.MoleculeSet");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
    ...
    public ValidationReport validateReactionSet(IReactionSet subject) {
        logger.info("Validating org.openscience.cdk1.ReactionSet");
        ValidationReport report = new ValidationReport();
        // apply validators
        for (IValidator test : validators.values()) {
