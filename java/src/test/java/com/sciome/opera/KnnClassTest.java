...
import com.sciome.opera.calc.math.KnnClass;

public class KnnClassTest {
	@Test
	public void test() {
		...
		assertEquals(KnnClass.calc(neighborsClass, neighborsDistance, 3, 2), new Integer(1));
	}
	...
	public void test2() {
		...
		RealVector neighborsClass = MatrixUtils.createRealVector(tempClass);
		RealVector neighborsDistance = MatrixUtils.createRealVector(tempDistance);
		assertEquals(KnnClass.calc(neighborsClass, neighborsDistance, 5, 3), new Integer(5));
	}
}
