...
public class KnnPred2Test {
	...
	public void test() {
		...
		Integer K = 3;
		Prediction test = KnnPred2.predict(Xtest, X, clazz, K, DistanceType.euclidean, PretreatmentType.cent);
		...
		actual.setClassPred(MatrixUtils.createColumnRealMatrix(classPredArray));
		actual.setClassPredW(MatrixUtils.createColumnRealMatrix(classPredW));
